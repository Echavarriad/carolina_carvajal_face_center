  ...
  ElementsRenderer = (function() {
    ...
    ElementsRenderer.prototype.createFolderLi = function(node) {
      ...
      if (escaped_featured == 1) {
        title_span.innerHTML = escaped_name + ' <i class="fa fa-star"></i>';
      }else if (escaped_superfeatured == 1) {
        title_span.innerHTML = escaped_name + ' <i class="fa fa-star"></i><i class="fa fa-star"></i>';
      }else{
