...
<html>
  ...
  <body class="hold-transition login-page">
    ...
    <div class="login-box">
      ...
      <!-- /.login-logo -->
      <a href="{{ route('admin.login') }}">< Regresar</a>
      <div class="login-box-body">        
         ...
         @endif 
            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.forgot') }}">
              {{ csrf_field() }}
              <p class="title-admin">Ingrese el correo registrado.</p>
